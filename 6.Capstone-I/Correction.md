...
```
  File "300118196.py", line 3
SyntaxError: Non-ASCII character '\xc3' in file 300118196.py on line 3, but no encoding declared; see http://python.org/dev/peps/pep-0263/ for details
```
...
```
entrer le nombre d'heure ('le nombre de minutes est \xc3\xa9gale \xc3\xa0 ', 180)
```
